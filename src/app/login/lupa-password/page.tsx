  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-4 pt-10 sm:pt-16 max-w-md mx-auto">
      ...
      <div className="flex items-center gap-2">
        <Link href="/login">
          <Button variant="ghost" size="icon" className="rounded-full w-9 h-9 text-slate-600 hover:bg-slate-100">
            <ArrowLeft className="w-5 h-5" />
          </Button>
        </Link>
        <div>
          <h1 className="text-lg sm:text-xl font-bold text-slate-800">Reset PIN / Sandi Toko</h1>
          <p className="text-xs text-slate-500">Pulihkan kata sandi akun toko Anda</p>
        </div>
      </div>
      ...
      <Card className="border-slate-200 shadow-sm overflow-hidden">
        <CardHeader className="pb-3 pt-6 border-b border-slate-100">
          <CardTitle className="text-sm sm:text-base font-bold text-slate-800 flex items-center gap-2">
            <KeyRound className="w-5 h-5 text-teal-700" /> Verifikasi Identitas Toko
          </CardTitle>
        </CardHeader>

        <CardContent className="space-y-4 pt-4 p-6">
          {success ? (
            <div className="p-4 bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs sm:text-sm rounded-xl flex items-center gap-3">
            ...
            <form onSubmit={handleReset} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs sm:text-sm p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-teal-500 font-mono text-slate-800"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs sm:text-sm p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-teal-500 text-slate-800"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full text-xs sm:text-sm p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-teal-500 pr-10 text-slate-800 font-mono font-bold"
                  />
                  <button
                    type="button"
